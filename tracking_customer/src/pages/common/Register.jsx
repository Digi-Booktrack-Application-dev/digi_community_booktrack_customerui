...
const Register = () => {
  ...
  const handleRegister = async (e) => {
    ...
    if (role === "admin")
      payload.adminCode = String(formData.get("adminCode") || "");
      ...
      <div className="register-form-container">
        <div className="register-form-card">
          ...
          <form className="register-form" onSubmit={handleRegister}>
            ...
            {role === "admin" && (
              <div>
                ...
                {fieldErrors.adminCode && (
                  <p className="field-error">{fieldErrors.adminCode}</p>
                )}
              </div>
            )}
            ...
            {formMessage && (
              <p
                className={`form-status ${formMessageType === "success" ? "form-status-success" : "form-status-error"}`}
              >
                {formMessage}
              </p>
            )}
